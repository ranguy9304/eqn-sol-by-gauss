...
double a[3][4]={{10,1,2,12},{5,10,1,11},{4,1,10,10}};//the values in the matrix A:B

float diff=0;//the degree of accuracy put zero if solving with no of iterations 
...
int main() {
    ...
    for (i;i<iterations;i++){
        ...
        ya=(a[1][3]-xb*(a[1][0])-zb*(a[1][2]))/a[1][1];
        za=(a[2][3]-xb*(a[2][0])-yb*(a[2][1]))/a[2][2];
